...
/**
 * <p>CIILSupplyChainTradeSettlementType complex typeのJavaクラス。
 * 
 ...
 *         &lt;element name="SpecifiedCIILTradeSettlementMonetarySummation" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:31}CIILTradeSettlementMonetarySummationType" minOccurs="0"/>
...
public class CIILSupplyChainTradeSettlementType {
    ...
    /**
     * specifiedCIILTradeSettlementMonetarySummationプロパティの値を取得します。
     * 
     * @return
     *     possible object is
    ...
    /**
     * specifiedCIILTradeSettlementMonetarySummationプロパティの値を設定します。
     * 
     * @param value
     *     allowed object is
     *     {@link CIILTradeSettlementMonetarySummationType }
